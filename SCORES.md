...
scored on September 16, 2026 by `scripts/score.py` with platform access,
...
## build-doctrine: 3.4 of 5 across 9 rules (doctrine)
...
| security-policy | 4 | SECURITY.md present; this scorer runs in CI |
| contributing | 4 | CONTRIBUTING.md present; this scorer runs in CI |
| decisions-record | 4 | 27 numbered entries; a test recounts them |
| commit-subjects | 0 | 1 of 15 recent subjects lack a leading identifier |
